		...
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			<div className="relative bg-zinc-900 border border-zinc-800 rounded-2xl p-6 w-full max-w-lg mx-4 shadow-2xl fade-in">
				<div className="flex items-center gap-3 mb-4">
					...
					<h3 className="text-lg font-semibold">Secret Regenerated</h3>
				</div>
				<p className="text-sm text-zinc-400 mb-2">
					New secret for{" "}
					<code className="px-1.5 py-0.5 bg-zinc-800 rounded text-cyan-400">
						{repo}
					</code>
				</p>
				<p className="text-xs text-amber-400 mb-4">
					&#9888;&#65039; Update this secret in GitHub's webhook settings
				</p>
				...
				<div className="mt-6">
					<button
						type="button"
						onClick={onClose}
						className="w-full py-2.5 px-4 rounded-lg text-sm font-semibold text-zinc-950 bg-gradient-to-r from-amber-400 to-orange-400 hover:from-amber-300 hover:to-orange-300 transition-all"
					>
						Done
					</button>
				</div>
